    ...
    <div className="space-y-8">
      ...
      <section className="text-center py-12 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
          Get comprehensive stock analysis with AI-powered insights, technical
      ...
      <section className="grid md:grid-cols-3 gap-6">
        <div className="text-center p-6 bg-white rounded-lg border">
          ...
          <p className="text-gray-600 text-sm">
            Advanced technical indicators and chart patterns for informed
            trading decisions
          </p>
        </div>
      ...
      <section className="bg-gray-900 text-white rounded-lg p-8 text-center">
        ...
        <p className="text-gray-300 mb-6">
          Enter any stock symbol above to get started with comprehensive
          analysis
        </p>
