        ...
        <div className="container mx-auto px-4 py-12 sm:py-16">
          <div className="text-center space-y-6">
            ...
            <p className="max-w-3xl mx-auto text-lg text-muted-foreground leading-relaxed">
              Explore real-time market data, interactive charts, and educational
              content. Learn while you analyze with our comprehensive market
              tools.
            </p>
                ...
                >
                  <CardContent className="p-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p
                        className={`text-sm font-medium ${getTrendColor(index.trend)}`}
                      >
                        {index.change}
                      </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Explore different timeframes and instruments. Click on any chart
              to expand and analyze in detail.
            </p>
          </div>
      ...
      <section className="py-12 sm:py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Enhance your trading knowledge with our educational content and
              interactive lessons
            </p>
          </div>
