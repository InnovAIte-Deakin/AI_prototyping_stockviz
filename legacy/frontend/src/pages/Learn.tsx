        ...
        <div className="container mx-auto px-4 py-12 sm:py-16">
          <div className="text-center space-y-6">
            ...
            <p className="max-w-3xl mx-auto text-lg text-muted-foreground leading-relaxed">
              Master the art of investing with our comprehensive courses,
              interactive lessons, and practical tools. From beginner basics to
              advanced strategies.
            </p>
          </div>
        </div>
          ...
          <Tabs defaultValue="courses" className="w-full">
            ...
            <TabsContent value="courses" className="mt-8">
              <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground">
                  Choose from our comprehensive library of investment courses
                </p>
              </div>
                    ...
                    >
                      <CardHeader>
                        <div className="flex items-center justify-between">
                          <div
                            className={`flex items-center justify-center w-12 h-12 bg-gradient-to-r ${course.color} rounded-xl`}
                          >
            ...
            <TabsContent value="progress" className="mt-8">
              <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground">
                  Track your learning journey and completed lessons
                </p>
              </div>
                      ...
                      {lessons.slice(0, 3).map((lesson) => (
                        ...
                        >
                          <div className="flex items-center space-x-3">
                            <CheckCircle
                              className={`h-4 w-4 ${lesson.completed ? "text-green-500" : "text-muted-foreground"}`}
                            />
                            <div>
            ...
            <TabsContent value="achievements" className="mt-8">
              <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground">
                  Unlock achievements as you progress through your learning
                  journey
                </p>
              </div>
      ...
      <section className="py-12 bg-muted/30">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Join thousands of successful investors who have mastered the markets
