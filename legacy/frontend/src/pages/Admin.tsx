    ...
    <div className="space-y-6">
      ...
      <div className="prose max-w-none">
        <p className="text-slate-600">
          Monitor system health, API connections, and cache status. Use cache
          management tools to optimize performance.
        </p>
      </div>
      ...
      <section className="grid grid-cols-1 gap-6">
        <div className="border rounded-md p-4 bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="font-medium">
                {health.data?.environment || "Unknown"}
              </div>
            </div>
            <div>
              ...
              <div className="font-medium">
                {health.data?.uptime
                  ? `${health.data.uptime.toFixed(2)} seconds`
                  : "Unknown"}
              </div>
            </div>
            <div>
        ...
        <div className="border rounded-md p-4 bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <div
                className={`font-medium ${keys.data?.alpha_vantage_configured ? "text-green-600" : "text-red-600"}`}
              >
                {keys.data?.alpha_vantage_configured
                  ? "Configured"
                  : "Not Configured"}
              </div>
            </div>
            <div>
              ...
              <div
                className={`font-medium ${keys.data?.gemini_configured ? "text-green-600" : "text-red-600"}`}
              >
            ...
            <div className="md:col-span-2">
              ...
              <div
                className={`font-medium ${keys.data?.ready_for_development ? "text-green-600" : "text-red-600"}`}
              >
        ...
        <div className="border rounded-md p-4 bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <div className="text-sm text-slate-600">Alpha Vantage</div>
              <div
                className={`font-medium ${conn.data?.alpha_vantage?.ready ? "text-green-600" : "text-red-600"}`}
              >
            ...
            <div>
              <div className="text-sm text-slate-600">Gemini AI</div>
              <div
                className={`font-medium ${conn.data?.gemini?.ready ? "text-green-600" : "text-red-600"}`}
              >
            ...
            <div className="md:col-span-2">
              ...
              <div
                className={`font-medium ${conn.data?.overall_status === "ready" ? "text-green-600" : "text-red-600"}`}
              >
        ...
        <div className="border rounded-md p-4 bg-white">
          ...
          <div className="mt-3 text-xs text-slate-500">
            Clearing removes all cached data. Cleaning removes only expired
            entries.
          </div>
        </div>
      </section>
