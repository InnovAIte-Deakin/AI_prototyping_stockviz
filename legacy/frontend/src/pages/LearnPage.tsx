        ...
        <div className="container mx-auto px-4 py-12 sm:py-16">
          <div className="text-center space-y-6">
            ...
            <p className="max-w-3xl mx-auto text-lg text-muted-foreground leading-relaxed">
              Master the art of stock analysis with our comprehensive courses,
                  ...
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div className="space-y-2">
                        <div
                          className={`inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-r ${course.color} group-hover:scale-110 transition-transform duration-300`}
                        >
