      ...
      <main className="w-full max-w-[440px] flex flex-col gap-10">
        ...
        >
          <div className="mb-10 text-center">
            <h2 className="text-2xl font-semibold tracking-tight text-[#2d3433] mb-2">
              Welcome back
            </h2>
            <p className="text-[#5a6060] text-sm">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
            <div className="space-y-1.5">
              <Label
                className="block text-[10px] font-bold uppercase tracking-widest text-[#5a6060] mb-2"
                htmlFor="email"
              >
                Email Address
              </Label>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center mb-2">
                ...
                <a
                  className="text-[10px] font-bold text-[#5f5e5e] hover:text-[#2d3433] transition-colors"
                  href="#"
                >
                  Forgot password?
                </a>
        ...
        <p className="text-center text-sm text-[#5a6060]">
          ...
          <Link
            className="font-semibold text-[#5f5e5e] hover:text-[#2d3433] transition-colors"
            to="/register"
          >
            Sign up for free
          </Link>
